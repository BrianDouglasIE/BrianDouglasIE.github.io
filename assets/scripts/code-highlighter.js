(function (root, factory) {
    ...
    var reset = function (cls, styles = {
        keywords: 'color:#005cc5; font-weight:italic;',
        function: 'color:#005cc5; font-weight:bold;',
        punctuation: 'color:#333;',
        strings: 'color:#22863a; font-style:italic;',
        comments: 'color:#a8a8a8; font-style:italic;',
        ...
        if (cls) {
            ...
            microlighted = _document.getElementsByTagName('pre');
        }
                ...
                if (!chr || // end of content
                    ...
                    if (token) {
                        ...
                        if (token === 'function') {
                            ...
                            ).setAttribute('style', styles.function)
                        } else {
                            el[appendChild](
                                node = _document.createElement('span')
                            ).setAttribute('style', [
